                      ...
                      <tr key={inquiry.id} className="hover:bg-secondary/50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <Select
                            ...
                            onValueChange={(value) =>
                              handleStatusChange(inquiry.id, value as "new" | "in_progress" | "resolved")
                            }
                          >
                            <SelectTrigger className={`w-32 text-xs border ${getStatusBadgeClass(inquiry.status)}`}>
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="new">New</SelectItem>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base">{selectedInquiry.organization || "—"}</p>
                    </div>
                    <div>
