              ...
              <div className="card-institutional p-6">
                ...
                >
                  ...
                  <text
                    ...
                    fontWeight="bold"
                  >
                    Pakistan's Mineral Regions
                  </text>

                  {/* Simplified Pakistan Map Outline */}
                  <path
                    d="M 150 80 L 180 70 L 220 80 L 250 70 L 270 90 L 280 120 L 290 160 L 285 200 L 270 240 L 250 280 L 230 320 L 210 360 L 190 400 L 170 420 L 150 410 L 130 380 L 120 340 L 110 300 L 100 260 L 95 220 L 100 180 L 110 140 L 130 100 Z"
                    fill="#f5f1e8"
                    stroke="#2d5a3d"
                    strokeWidth="2"
                  />
                  ...
                  <text x="85" y="475" fontSize="11" fill="#2d5a3d">
                  ...
                  <circle
                    ...
                    opacity="0.3"
                  />
                  <text x="255" y="475" fontSize="11" fill="#2d5a3d">
                    Resource Regions
                  </text>
                </svg>
              </div>
