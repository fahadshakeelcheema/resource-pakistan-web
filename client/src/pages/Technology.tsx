          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ${hoveredArea === "mobility" ? "max-h-48 opacity-100 mt-2" : "max-h-0 opacity-0"}`}
                >
                  <p
                  ...
                  >
                    ...
                    frameworks. We support institutional planning for Pakistan's
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ${hoveredArea === "pilot" ? "max-h-48 opacity-100 mt-2" : "max-h-0 opacity-0"}`}
                >
                  <p
                    className="text-body text-muted-foreground"
                    style={{ color: "#c8bfb6" }}
                  >
                    ...
                    initiatives in emerging technologies. We help institutional
                    stakeholders understand implementation requirements and
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ${hoveredArea === "industrial" ? "max-h-48 opacity-100 mt-2" : "max-h-0 opacity-0"}`}
                >
                  <p
                    className="text-body text-muted-foreground"
                    style={{ color: "#c8bfb6" }}
                  >
                    ...
                    supply chain optimization, and productivity enhancement. We
                    support long-term industrial planning and competitiveness.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-300 ${hoveredArea === "research" ? "max-h-48 opacity-100 mt-2" : "max-h-0 opacity-0"}`}
                >
                  <p
                    className="text-body text-muted-foreground"
                    style={{ color: "#c8bfb6" }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-6 items-center">
              ...
              <div>
                ...
                <p className="text-body">
                  ...
                  institutional decision-making and long-term strategic
                  planning.
                </p>
              </div>
